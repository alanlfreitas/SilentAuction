...
travel_log = {
  ...
  "Brazil": {"cities_visited": ["Fortaleza", "Rio", "Presidente Figueiredo", "Itacoatiara", "Iranduba", "Boa Vista"], "total_visits": 7}
}
...
travel_log = [
  ...
  {
    "country": "Brazil",
    "cities_visited": ["Fortaleza", "Rio", "Presidente Figueiredo", "Itacoatiara", "Iranduba", "Boa Vista"],
    "total_visits": 7
  }
]